...
"          $Id: fonts.vim 29 2007-09-24 11:40:36Z krischik@users.sourceforge.net $
...
"      Version: 1.5
"    $Revision: 29 $
"     $HeadURL: http://vim-scripts.googlecode.com/svn/trunk/1337%20Multi%20OS%20Font%20Plugin/plugin/fonts.vim $
