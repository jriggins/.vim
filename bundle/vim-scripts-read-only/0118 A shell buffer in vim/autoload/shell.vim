...
"	   $Id: shell.vim 77 2008-01-17 17:37:38Z krischik@users.sourceforge.net $
"    Copyright: Copyright (C) 2006 Martin Krischik
" Name Of File: plugin/modelines.vim
" Last Changed: Monday, 09 May 2006
"      Version: 2.0
"    $Revision: 77 $
"     $HeadURL: http://vim-scripts.googlecode.com/svn/trunk/0118%20A%20shell%20buffer%20in%20vim/autoload/shell.vim $
