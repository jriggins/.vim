...
"	   $Id: martin_krischik.vim 77 2008-01-17 17:37:38Z krischik@users.sourceforge.net $
"    Copyright: Copyright (C) 2006 Martin Krischik
"   Maintainer:	Martin Krischik
"      $Author: krischik@users.sourceforge.net $
"	 $Date: 2008-01-17 11:37:38 -0600 (Thu, 17 Jan 2008) $
"      Version: 4.0
"    $Revision: 77 $
"     $HeadURL: http://vim-scripts.googlecode.com/svn/trunk/1538%20Martin%20Krischik%20Color%20Scheme/colors/martin_krischik.vim $
