...
"	   $Id: btm.vim 50 2007-10-08 18:42:51Z krischik@users.sourceforge.net $
"    Copyright: Copyright (C) 2007 Martin Krischik
"   Maintainer: Martin Krischik
"               John Leo Spetz <jls11@po.cwru.edu>
"      $Author: krischik@users.sourceforge.net $
"	 $Date: 2007-10-08 13:42:51 -0500 (Mon, 08 Oct 2007) $
"      Version: 1.1
"    $Revision: 50 $
"     $HeadURL: http://vim-scripts.googlecode.com/svn/trunk/2029%204NT%20Bundle/autoload/btm.vim $
