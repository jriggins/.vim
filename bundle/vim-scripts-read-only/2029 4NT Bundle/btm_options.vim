...
"          $Id: btm_options.vim 48 2007-09-27 12:23:23Z krischik@users.sourceforge.net $
"    Copyright: Copyright (C) 2007 Martin Krischik
"   Maintainer: Martin Krischik
"               John Leo Spetz <jls11@po.cwru.edu>
"      $Author: krischik@users.sourceforge.net $
"        $Date: 2007-09-27 07:23:23 -0500 (Thu, 27 Sep 2007) $
"      Version: 1.1
"    $Revision: 48 $
"     $HeadURL: http://vim-scripts.googlecode.com/svn/trunk/2029%204NT%20Bundle/btm_options.vim $
