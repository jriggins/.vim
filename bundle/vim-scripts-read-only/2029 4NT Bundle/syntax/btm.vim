...
"          $Id: btm.vim 51 2007-10-09 18:43:58Z krischik@users.sourceforge.net $
"    Copyright: Copyright (C) 2007 Martin Krischik
"   Maintainer: Martin Krischik <krischik@users.sourceforge.net>
"               John Leo Spetz <jls11@po.cwru.edu>
"      $Author: krischik@users.sourceforge.net $
"        $Date: 2007-10-09 13:43:58 -0500 (Tue, 09 Oct 2007) $
"      Version: 1.1
"    $Revision: 51 $
"     $HeadURL: http://vim-scripts.googlecode.com/svn/trunk/2029%204NT%20Bundle/syntax/btm.vim $
