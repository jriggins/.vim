...
"          $Id: backup.vim 73 2007-12-13 13:50:01Z krischik@users.sourceforge.net $
...
"      Version: 2.2
"    $Revision: 73 $
"     $HeadURL: http://vim-scripts.googlecode.com/svn/trunk/1537%20Numbered%20Backups/plugin/backup.vim $
